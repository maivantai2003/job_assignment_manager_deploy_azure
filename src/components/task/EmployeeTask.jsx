...
const EmployeeSelect = ({ selectedEmployees, setSelectedEmployees,nhanViens}) => {
    ...
    const filteredNhanViens = !nhanViens || nhanViens.length === 0
        ? nhanviens
        : nhanviens.filter(
            (item) => !nhanViens.some((nv) => nv.maNhanVien === item.maNhanVien)
        );
